...
* Возможность полного отключения синтеза речи (опция bvi_use_responsivevoice);
* Возможность использования jQuery Cookie Plugin (опция bvi_jquery_cookies);
* Вывод и скрытие сообщений консоли (опция bvi_debug);
